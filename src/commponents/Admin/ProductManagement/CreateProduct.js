            ...
            <form className='py-10 w-5/6 mx-auto grid grid-cols-12 gap-8'>
                ...
                <div className='w-full'>
                  <div className='flex gap-4'>
                    <div class="mb-3 w-full">
                      ...
                      <input onChange={handleOnChange} name='name' type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />

                    </div>
                    <div class="mb-3 w-full">
                      <label for="base-input" class="block mb-2 text-sm  font-medium text-gray-900">Nhãn</label>
                      <input onChange={handleOnChange} name='labeller' type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
                  ...
                  <div className='flex gap-4'>
                    <div class="mb-3 w-2/3">
                      ...
                      <input onChange={handleOnChange} type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
                  ...
                  <div class="mb-3 w-full">
                    ...
                    <input onChange={handleOnChange} name='prescriptionName' type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
                  ...
                  <div class="mb-5 border border-gray-300 p-5">
                    ...
                    <div className="flex gap-4">
                      <div className='mb-3 w-2/3'>
                        ...
                        <input onChange={handleOnChange} name='manufactor.name' type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2" required />
                      </div>
                    ...
                    <div className="flex gap-4">
                      <div className='mb-3 w-2/3'>
                        ...
                        <input onChange={handleOnChange} name='manufactor.source' type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2" required />
                      </div>
                      <div className='mb-3 w-1/3'>
                        <label class="block mb-2 text-sm font-medium text-gray-900">Điểm số</label>
                        <input onChange={handleOnChange} name='manufactor.score' type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2" required />
                      </div>
                    </div>
                    <div className=''>
                      <label class="block mb-2 text-sm font-medium text-gray-900">Công ty</label>
                      <input onChange={handleOnChange} name='manufactor.company' type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2" required />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className='col-span-12 flex flex-wrap'>
                ...
                <div className='mb-3 w-full'>
                  ...
                  <textarea onChange={handleOnChange} rows={3} name='indication' type="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
                </div>
                <div className='mb-3 w-full'>
                  <label className="block mb-2 text-sm font-medium text-gray-900">Dược lực học</label>
                  <input onChange={handleOnChange} name='pharmacodynamic' type="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
                </div>
                <div className='mb-3 w-full'>
                  <label className="block mb-2 text-sm font-medium text-gray-900">Cơ chế hoạt động</label>
                  <textarea onChange={handleOnChange} rows={2} name='mechanismOfAction' type="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
                </div>
                <div className='w-full flex gap-4'>
                  <div className='mb-3 w-1/2'>
                    <label className="block mb-2 text-sm font-medium text-gray-900">Hấp thụ</label>
                    <input onChange={handleOnChange} rows={2} name='asorption' type="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
                  </div>
                  <div className='mb-3 w-1/2'>
                    <label className="block mb-2 text-sm font-medium text-gray-900">Độc tính</label>
                    <input onChange={handleOnChange} rows={2} name='toxicity' type="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
                  </div>
                </div>
              </div>
              <div className='col-span-12'>
                ...
                <div className='flex gap-4'>
                  <div className='mb-3 w-1/2'>
                    ...
                    <textarea onChange={handleOnChange} rows={2} name='productAllergyDetail.detail' type="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
                  </div>
                  <div className='mb-3 w-1/2'>
                    <label className="block mb-2 text-sm font-medium text-gray-900">Tóm tắt về dị ứng thuốc</label>
                    <textarea onChange={handleOnChange} rows={2} name='productAllergyDetail.summary' type="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
                  </div>
                </div>
              </div>
              <div className='col-span-12'>
                ...
                <div className='flex gap-4'>
                  <div className='mb-3 w-1/2'>
                    ...
                    <input onChange={handleOnChange} name='contraindication.relationship' type="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
                  </div>
                  <div className='mb-3 w-1/2'>
                    <label className="block mb-2 text-sm font-medium text-gray-900">Giá trị</label>
                    <input onChange={handleOnChange} name='contraindication.value' type="text" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
                  </div>
                </div>
              </div>
